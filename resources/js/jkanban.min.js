      ...
      this.jKanban = function () {
        ...
        arguments[0] && "object" == _typeof(arguments[0]) && (this.options = function (e, t) {
          ...
          !function () {
            ...
            t.classList.add("kanban-container w-auto"), e.container = t, document.querySelector(e.options.element).dataset.hasOwnProperty("board") ? (url = document.querySelector(e.options.element).dataset.board, window.fetch(url, {
              method: "GET",
              headers: {
          ...
          for (var p in t) {
            var v = t[p];
            n || e.options.boards.push(v), e.options.responsivePercentage || (if(!e.container.classList.contains("w-auto")){ e.container.classList.add("w-auto");});
            var m = document.createElement("div");
            m.dataset.id = v.id, m.dataset.order = e.container.childNodes.length + 1, m.classList.add("kanban-board"), e.options.responsivePercentage ? m.style.width = "max-content" : m.style.width = "max-contet", m.style.marginLeft = e.options.gutter, m.style.marginRight = e.options.gutter, m.style.height = "max-content";
