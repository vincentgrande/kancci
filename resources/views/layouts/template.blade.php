                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow d-sm-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                            ...
                            <form class="form-inline mr-auto w-100 navbar-search" action="{{route('SearchResultMobile')}}" method="post">
                                @csrf
                                <div class="input-group">
                                    <input type="text" id="searchResultMobile" name="searchResultMobile" class="form-control bg-light border-0 small"
